...
export default function AIAssistantUI() {
  ...
  const handleNavigate = (destination) => {
    console.log("[v0] Navigate to:", destination)
    window.dispatchEvent(new CustomEvent("navigate-to-tab", { detail: { tab: destination } }))
    setSidebarOpen(false)
  }

  const handleToggleAIAssistant = () => {
    setShowAIAssistant((prev) => !prev)
    if (showLearningPanel) setShowLearningPanel(false)
  }
    ...
    <div className="h-screen w-full bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <div className="flex h-full w-full">
        <Sidebar
          ...
          onToggleLearningPanel={handleToggleLearningPanel}
        />
