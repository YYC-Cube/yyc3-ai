    ...
    <>
      {!isOpen && (
        <button
          ...
          className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm transition-all hover:scale-105 hover:shadow-lg"
          title="打开AI对话"
        >
          AI
        </button>
            ...
            {messages.length === 0 ? (
              <div className="flex h-full items-center justify-center">
                <div className="text-center">
                  <MessageSquare className="mx-auto mb-3 h-12 w-12 text-zinc-400" />
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">开始新对话</p>
                  <p className="mt-1 text-xs text-zinc-400 dark:text-zinc-500">选择模型并输入您的问题</p>
                </div>
              </div>
            ) : (
